              ...
              <div class="card text-white bg-dark mb-3" style="width: 18rem;">
                <div class="card-body">
                  ...
                  <div class="card-footer">
                    <?php echo "<p>Date: ".$row['date']."<br>"?>
                    <?php echo "Duration: ".$row['duration']." hours<br>"?>
                    <?php echo "Price: RM".$row['price']."<br>"?>
                    <?php echo "Quota: ".$row['quota']." persons</p>"?>

                    </div>
                  <a href="registercourse.php?id=<?php echo $row['courseid']?>" class="btn-get-started">Register</a>  
                </div>
              </div>
            </div>
            ...
            <div class="accordion accordion-flush" id="faqlist" data-aos="fade-up" data-aos-delay="100">
              ...
              <div class="accordion-item">
                ...
                <div id="faq-content-1" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                    Yes. Each participant who completes this seminar will receive a certificate of completion.
                  </div>
                </div>
              </div><!-- # Faq item-->
              ...
              <div class="accordion-item">
                <h3 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-2">
                    ...
                    Can I attend this seminar remotely? How does that work?
                  </button>
                </h3>
                <div id="faq-content-2" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                    Yes, our seminar is available remotely through a screen sharing software (we use Zoom). Participants can hear the instruction, ask questions, and even share their screen with the instructor. However, because our seminar is activity-based and taught by a live instructor, we strongly encourage participants who are local to the area to attend in person!
                  </div>
                </div>
              </div><!-- # Faq item-->
              ...
              <div class="accordion-item">
                ...
                <div id="faq-content-4" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                    Yes. Our seminar is taught in in-person in Selangor with a live instructor in the same room as the participants.
                  </div>
                </div>
              </div><!-- # Faq item-->
              ...
              <div class="accordion-item">
                <h3 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-5">
                    ...
                    What do I need to bring to class? Are computers provided? What operating system?
                  </button>
                </h3>
                <div id="faq-content-5" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                    We provide computers with the software for the participants, so you can travel light. You can bring a pen and paper/notebook to take notes if you'd like.
                  </div>
                </div>
              </div><!-- # Faq item-->
          ...
          <div class="col-lg-4">
            ...
            <div class="info-container d-flex flex-column align-items-center justify-content-center">
              <div class="info-item d-flex">
                ...
                <div>
                  <h4>Location:</h4>
                  <p>Universiti Tenaga Nasional, Jalan Ikram-UNITEN, 43000 Kajang, Selangor</p>
                </div>
              </div><!-- End Info Item -->
